...
*/
        ...
        btRegistro.setOnClickListener {
            val intent = Intent(this, EmpleadosVista::class.java)
           // intent.putExtra("id", id)
            startActivity(intent)
        }
        btAsistencia.setOnClickListener {
            val intent = Intent(this, AsistenciaVista::class.java)
            intent.putExtra("id", id)
            startActivity(intent)
        }
        btMisVis.setOnClickListener {
            val intent = Intent(this, MisionVisionVista::class.java)
            intent.putExtra("id", id)
            startActivity(intent)
        }
        btConocenos.setOnClickListener {
            val intent = Intent(this, ConocenosReproVista::class.java)
            //intent.putExtra("id", id)
